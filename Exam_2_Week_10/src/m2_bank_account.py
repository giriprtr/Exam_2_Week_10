...
def run_test_init():
    ...
    print("Actual:  ", b1.name, b1.bal, b1.account_number)
    if (expected_name == b1.name) and (expected_balance == b1.bal) and (expected_account_number == b1.account_number):
    ...
    print("Expected:", expected_name, expected_balance, expected_account_number)
    print("Actual:  ", b2.name, b2.bal, b2.account_number)
    if (expected_name == b2.name) and (expected_balance == b2.bal) and (
    ...
    print("Expected:", expected_name, expected_balance, expected_account_number)
    print("Actual:  ", b3.name, b3.bal, b3.account_number)
    if (expected_name == b3.name) and (expected_balance == b3.bal) and (
